...
int main() {
	...
	//
	// vtkDataSetMapper: sukuriamas duomenų rinkinio mapperis
	...
	//
	// vtkActor: sukuriamas duomenų rinkinio aktorius
	...
	glyph->SetInputConnection(read->GetOutputPort());//cia
	...
	//
	// vtkActor: sukuriamas spalvų skalės aktorius 
	...
	//
	// vtkRenderer: sukuriamas renderer, prie kurio prijungiami aktoriai
	...
	//
	// vtkRenderWindowInteractor: sukuriamas interaktoriaus objektas,
	// prie kurio prijungiams atvaizdavimo langas
